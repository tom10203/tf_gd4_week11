...
Shader "PolyToots/Amplify/SailBlow"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Strength("Strength", Range( 0 , 1)) = 1
		_NoiseScale("NoiseScale", Float) = 1
		_MaskScale("MaskScale", Float) = 0.75
		[ASEEnd]_Jitter("Jitter", Float) = 0.2
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_17_0 = ( 1.0 - pow( ( appendResult23_g1.x * _MaskScale ) , 2.0 ) );
				float _strength25 = _Strength;
				float2 temp_cast_0 = (( _TimeParameters.x * ( _strength25 * 5.0 ) )).xx;
				float2 texCoord37 = v.texcoord.xy * float2( 1,1 ) + temp_cast_0;
				float simplePerlin2D36 = snoise( texCoord37*_NoiseScale );
				...
				#endif
				float3 vertexValue = ( v.ase_normal * ( ( temp_output_17_0 + ( simplePerlin2D36 * _Jitter ) ) * _strength25 ) );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_17_0 = ( 1.0 - pow( ( appendResult23_g1.x * _MaskScale ) , 2.0 ) );
				float _strength25 = _Strength;
				float height107_g3 = ( temp_output_17_0 * _strength25 );
				...
				float3 Normal = worldToTangentDir42_g3;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float _strength25 = _Strength;
				float2 temp_cast_0 = (( _TimeParameters.x * ( _strength25 * 5.0 ) )).xx;
				float2 texCoord37 = v.texcoord0.xy * float2( 1,1 ) + temp_cast_0;
				float simplePerlin2D36 = snoise( texCoord37*_NoiseScale );
				simplePerlin2D36 = simplePerlin2D36*0.5 + 0.5;
...
/*ASEBEGIN
Version=18935
419;572;1082;427;2376.969;82.3092;2.090293;True;False
Node;AmplifyShaderEditor.RangedFloatNode;12;-1827.061,-146.0962;Inherit;False;Property;_Strength;Strength;0;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;25;-1533.651,-141.2726;Inherit;False;_strength;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-2011.396,986.3806;Inherit;False;Constant;_5;5;1;0;Create;True;0;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;27;-2027.396,879.196;Inherit;False;25;_strength;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;30;-1908.777,783.7026;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;-1845.338,923.785;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;13;-2032.739,164.6431;Inherit;False;Polar Coordinates;-1;;1;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;1;False;4;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;33;-1705.868,839.5778;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-1803.827,353.3772;Inherit;False;Property;_MaskScale;MaskScale;2;0;Create;True;0;0;0;False;0;False;0.75;0.75;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;14;-1801.827,212.3772;Inherit;False;FLOAT2;1;0;FLOAT2;0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.TextureCoordinatesNode;37;-1558.831,798.4061;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;35;-1510.307,949.8577;Inherit;False;Property;_NoiseScale;NoiseScale;1;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-1626.827,228.3772;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;1.38;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;21;-1409.798,229.1629;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-1223.237,1110.423;Inherit;False;Property;_Jitter;Jitter;3;0;Create;True;0;0;0;False;0;False;0.2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;36;-1302.985,879.2783;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;17;-1236.567,228.0318;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;-1039.201,892.2751;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;40;-837.9717,518.2268;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;26;-656.1783,636.9039;Inherit;False;25;_strength;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-482.1892,268.3194;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;10;-515.7423,-38.8992;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;45;-319.8509,608.7861;Inherit;False;Constant;_Float0;Float 0;4;0;Create;True;0;0;0;False;0;False;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-284.9205,71.03284;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;23;-138.1892,507.2663;Inherit;True;Normal From Height;-1;;3;1942fe2c5f1a1f94881a33d532e4afeb;0;2;20;FLOAT;0;False;110;FLOAT;0.5;False;2;FLOAT3;40;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;-329.9446,496.7531;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;23;20;42;0
WireConnection;23;110;45;0
WireConnection;42;0;17;0
WireConnection;42;1;26;0
WireConnection;1;1;23;40
WireConnection;1;8;11;0
ASEEND*/
//CHKSM=8F9200DEB1A80131DB9C716BB9A27258247B39EA