...
Shader "PolyToots/Amplify/BuildUp"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_BaseColour("Base Colour", Color) = (0.3882353,0.2156863,0.1294118,0)
		_BuildUpColour("BuildUp Colour", Color) = (1,1,1,0)
		_BuildUp("BuildUp", Range( 0 , 1)) = 0
		_Ramp("Ramp", Range( 0 , 1)) = 1
		[ASEEnd][Toggle]_IsMoss("Is Moss?", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_46_0 = ( v.ase_normal.y * _BuildUp );
				...
				#endif
				float3 vertexValue = ( min( pow( saturate( temp_output_46_0 ) , _Ramp ) , 0.05 ) * v.ase_normal );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_46_0 = ( IN.ase_normal.y * _BuildUp );
				float4 temp_output_58_0 = ( ( temp_output_46_0 * 5.0 ) * _BuildUpColour );
				float2 texCoord65 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float simplePerlin2D64 = snoise( texCoord65*5.0 );
				simplePerlin2D64 = simplePerlin2D64*0.5 + 0.5;
				
				float3 Albedo = ( _BaseColour + saturate( (( _IsMoss )?( ( temp_output_58_0 * simplePerlin2D64 ) ):( temp_output_58_0 )) ) ).rgb;
...
/*ASEBEGIN
Version=18935
1181;73;738;926;1532.937;-696.4316;1;True;False
Node;AmplifyShaderEditor.NormalVertexDataNode;10;-1767.145,7.81835;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;47;-1878.821,170.8507;Inherit;False;Property;_BuildUp;BuildUp;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;46;-1569.43,67.59285;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;48;-1334.515,69.95064;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;-1545.548,301.7127;Inherit;False;Property;_Ramp;Ramp;3;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;53;-1005.11,288.0388;Inherit;False;Constant;_005;0.05;2;0;Create;True;0;0;0;False;0;False;0.05;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;49;-1181.799,144.7067;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;55;-822.3655,344.7377;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMinOpNode;52;-836.393,175.473;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;64;-1027.618,1201.706;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;62;-399.8607,342.1765;Inherit;False;Property;_BaseColour;Base Colour;0;0;Create;True;0;0;0;False;0;False;0.3882353,0.2156863,0.1294118,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;57;-1339.424,744.5911;Inherit;False;Constant;_5;5;2;0;Create;True;0;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;58;-957.2396,731.1786;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;63;-565.1102,845.206;Inherit;False;Property;_IsMoss;Is Moss?;4;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;59;-1205.182,857.7916;Inherit;False;Property;_BuildUpColour;BuildUp Colour;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;56;-1153.571,728.2684;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;65;-1277.489,1227.739;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;54;-563.8044,141.4222;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;61;-105.7715,430.3062;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;60;-354.3986,745.2307;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;66;-745.9402,1014.623;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=A00A4E35A2975E270414F8AD9360C1392894BAC8