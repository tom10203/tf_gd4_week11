...
Shader "PolyToots/Amplify/VertPaint"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 appendResult47 = (float4(IN.ase_color.r , IN.ase_color.g , IN.ase_color.b , 0.0));
				
				float3 Albedo = appendResult47.xyz;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.5;
				float Occlusion = IN.ase_color.a;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
1286;73;633;926;1364.846;560.0875;2.753755;True;False
Node;AmplifyShaderEditor.VertexColorNode;46;-436.7807,-31.78569;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;47;-127.8081,-43.06815;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
